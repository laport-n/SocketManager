...
export const config:  Omit<RedisClientOptions<never, RedisScripts>, "modules"> = {
    url: process.env.SOCKET_REDIS_URL ? process.env.SOCKET_REDIS_URL : 'redis://127.0.0.1:6379',
    ...
    password: process.env.SOCKET_REDIS_PASSWORD ? process.env.SOCKET_REDIS_PASSWORD : 'toto',
